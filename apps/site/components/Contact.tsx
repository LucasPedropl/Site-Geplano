...
export const Contact: React.FC<ContactProps> = ({ data }) => {
  return (
    <Section id="contato" className="bg-geplano-green text-white overflow-hidden">
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="flex items-start gap-3 md:gap-5">
              ...
              <div className="min-w-0 flex-1 py-1">
                 <p className="text-xs md:text-sm text-geplano-gold font-bold uppercase mb-1 tracking-wider">Telefone</p>
                 <span className="font-semibold text-base md:text-xl block text-white break-words">{data.phone}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 md:gap-5">
              ...
              <div className="min-w-0 flex-1 py-1">
                 <p className="text-xs md:text-sm text-geplano-gold font-bold uppercase mb-1 tracking-wider">E-mail</p>
                 <a href={`mailto:${data.email}`} className="font-semibold text-base md:text-xl block text-white break-all hover:text-geplano-gold transition-colors leading-tight">
                    {data.email}
                 </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 md:gap-5">
              ...
              <div className="min-w-0 flex-1 py-1">
                 <p className="text-xs md:text-sm text-geplano-gold font-bold uppercase mb-1 tracking-wider">Endereço</p>
                 <span className="font-semibold text-base md:text-xl block text-white leading-tight">{data.address}</span>
              </div>
            </div>
          </div>
        </Reveal>
