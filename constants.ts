...
export const INITIAL_SITE_DATA: SiteData = {
	...
	hero: {
		...
		subtitle: "Gerenciamos obras de alto padrão com excelência construtiva, para proporcionar total tranquilidade aos nossos clientes.",
	...
	mission_vision_values: {
		...
		mission_text: "Transformar projetos em obras de alto padrão que unem sofisticação, confiança e exclusividade, proporcionando aos nossos clientes a tranquilidade de investir e viver em espaços planejados e executados com excelência.",
		vision_title: "Visão",
		vision_text: "Ser reconhecida até 2030 como referência em administração de obras de alto padrão no Espírito Santo, com um modelo exclusivo de gestão transparente e personalizada que transforma cada projeto em uma experiência única.",
		purpose_title: "Propósito",
		purpose_text: "Gerenciar obras de alto padrão com excelência construtiva, para proporcionar total tranquilidade aos nossos clientes.",
	...
	team: {
		title: "Nossos Sócios Fundadores",
		members: [
			{
				"name": "Luiz Silva",
				"role": "Diretor Técnico/Operacional",
				"description": "Engenheiro com mais de 40 anos de atuação, foi responsável pelo gerenciamento da implantação da Bahia Sul Celulose (Suzano/Mucuri-BA) e sócio fundador de empresa com 30 anos no setor industrial. Hoje, fortalece o corpo técnico da Geplano com sua experiência.",
				"image": "https://picsum.photos/300/300?random=1"
			},
			{
				"name": "Felipe Ferraz",
				"role": "Diretor Comercial/Administrativo",
				"description": "Engenheiro civil formado pela UFMG, com sólida experiência em gestão e orçamentação de obras. Atuou como diretor em empresa de referência no setor industrial e hoje lidera a área comercial e administrativa da Geplano.",
				"image": "https://picsum.photos/300/300?random=2"
			},
			{
				"name": "Ricardo Mota",
				"role": "Diretor de Engenharia/Suprimentos",
				"description": "Com experiência internacional de mais de 5 anos na Europa e ampla atuação em contratos e obras industriais, é sócio fundador e peça-chave na gestão de suprimentos e engenharia da Geplano.",
	...
	solution: {
		...
		subtitle: "Atuamos no modelo Obra por Administração, também chamado de Obra a Preço de Custo. Conheça os pilares da nossa solução:",
		...
		content: {
			...
			delivery: {
				"title": "Método G10",
				"subtitle": "Entregamos uma GESTÃO INTEGRADA única e exclusiva na região de atuação, que engloba o gerenciamento de todos os processos do pré-obra ao pós-obra.",
				"steps": [
	...
	differentiators: {
		...
		subtitle: "Unimos tecnologia de ponta a um método de gestão comprovado para oferecer uma experiência de construção sem precedentes em controle e eficiência.",
		app_title: "Sua Obra na Palma da Mão",
		app_text: "Com nosso aplicativo exclusivo, você tem o controle total do seu projeto, onde quer que esteja. É a materialização da nossa promessa de transparência e gestão inteligente.",
		app_features: [
			{
	...
	projects: {
		...
		subtitle: "Nosso portfólio é a prova do nosso compromisso com a qualidade, o design e a entrega de resultados que superam as expectativas.",
		filters: [
			"Todos",
			"Residencial",
			"Corporativo",
		...
		items: [
			{
				...
				"description": "Construção de prédio pré-moldado da cortadeira de papel com 10.000 m² de área construída."
			},
			{
				"id": 2,
				"category": ["industrial"],
				...
				"location": "Suzano - Mucuri/BA",
				"description": "Implantação de caldeira de biomassa e pipe rack com fundações através de hélice contínua e estaca raiz."
			},
			{
				"id": 3,
				"category": ["industrial"],
				...
				"description": "Alteamento do Aterro Industrial que envolveu uma movimentação superior a 100.000,00 m³ de terra."
			},
			{
				"id": 4,
				"category": ["industrial"],
				...
				"description": "Fechamento de 2.700,00m² de alvenaria armada com blocos estruturais e com vãos de até 14 metros de altura."
			},
			{
				"id": 9,
				...
				"description": "Construção Residencial Unifamiliar com 427,49 m² para Dr. Vitor Barbalho e Dra. Anamélia Dalla Bernardina."
			},
			{
				"id": 10,
				...
				"description": "2ª Fase da Construção com destinação hospitalar com 1.891,19 m²."
			}
		]
	},
	other_solutions: {
	...
	footer: {
		copyright: "Geplano Gestão e Consultoria de Obras. Todos os direitos reservados."
	}
};