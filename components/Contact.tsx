	...
	return (
		...
		>
			<div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
				<Reveal>
					<h2 className="text-3xl md:text-5xl font-display font-black uppercase mb-6 tracking-tight leading-tight wrap-break-word">
						{data.title}
					</h2>
					...
					<div className="space-y-6 md:space-y-8">
						<div className="flex items-start gap-3 md:gap-5">
							<div className="w-10 h-10 md:w-14 md:h-14 min-w-10 md:min-w-14 rounded-full bg-geplano-gold flex items-center justify-center text-white shadow-lg shrink-0">
							...
							<div className="min-w-0 flex-1 py-1">
								...
								<span className="font-semibold text-base md:text-xl block text-white wrap-break-word">
									{data.phone}
								</span>
							</div>
						</div>
