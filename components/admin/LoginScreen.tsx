...
export const LoginScreen: React.FC = () => {
	...
	const handleGoogleLogin = async () => {
		...
		try {
			...
			console.error(err);
			const maybe = err as { code?: string } | Error;
			if (
				typeof maybe === 'object' &&
				maybe !== null &&
				'code' in maybe &&
				maybe.code === 'auth/popup-closed-by-user'
			) {
			...
			>
				...
				<div className="p-8">
					...
					<div className="space-y-4">
						...
						<Link
							href="/"
							className="w-full inline-flex items-center justify-center gap-2 bg-gray-900 text-white font-bold py-3 rounded-lg transition-all hover:bg-gray-800"
						>
							Voltar para o site
						</Link>
